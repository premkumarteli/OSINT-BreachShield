...
for num in [1, 2, 3]:
    ...
    try:
        ...
        print(f'Notice: {draft_path} is currently locked by Word. Final saved to {final_path}.')

print('All 3 reports successfully created based on reference template!')
